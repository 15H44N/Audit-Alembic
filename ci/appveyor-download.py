...
parser.add_argument("--id", metavar="PROJECT_ID", default="jpassaro/Audit-Alembic", help="Project ID in AppVeyor.")
parser.add_argument("build", nargs="?", metavar="BUILD_ID", help="Build ID in AppVeyor. Eg: master-123")
